...
This [UserScript](https://openuserjs.org/about/Userscript-Beginners-HOWTO) will generate **BunnyButtons 🐰** alongside a sites regular download buttons. When clicked, the corresponding torrent will be sent to your torrent client using your custom settings. Integrating BunnyButtons into the page itself allows for support on both desktop and mobile devices. In addition, this integration has been done in a non-destructive manner, ensuring quiCKIE is friendly\compatible with other UserScripts and default browser functions.
